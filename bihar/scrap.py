...
def crawl_and_scrape(current_url, base_domain, state_name, download_dir="bhwcd_all_pdfs", metadata_file="crawl_metadata.json", max_depth=2, current_depth=0):
